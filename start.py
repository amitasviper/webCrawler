...
if __name__ == '__main__':
	...
	visit_pages(rel_url, 9, "santa_banta.txt")

	rel_url = '/jokes/universal-jokes/Hindi/414'
	obj = visit_pages(rel_url, 202, "haryanvi.txt")

	visited_url_list.append(rel_url)
	find_other_links(obj)